...
long triplets(vector<int> a, vector<int> b, vector<int> c) {
    ...
    sort(b.begin(), b.end());
    sort(c.begin(), c.end());
    auto it_end_a = unique(a.begin(), a.end());
    auto it_end_b = unique(b.begin(), b.end());
    auto it_end_c = unique(c.begin(), c.end());
    a.resize(distance(a.begin(),it_end_a));
    b.resize(distance(b.begin(),it_end_b));
    c.resize(distance(c.begin(),it_end_c));
